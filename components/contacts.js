...
export default function Contacts(props){
    ...
    <div className={styles.media}>
        ...
        <button><a href="https://www.linkedin.com/in/mason-choi-29b547220/" target="_blank" rel="noreferrer"><Image src="/home/images/LI-In-Bug.png" layout="responsive" width={540} height={540}/></a></button>
    </div>
    )
}